...
if ($user->profile()){
    ...
    $substringArray = explode(' ', $fullname);
    $firstName = $substringArray[0];
    $lastName = $substringArray[1];
...
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/E-Commerce/app/views/common/footer.php";
?>
<style>
#profbody{
    color: #797979;
